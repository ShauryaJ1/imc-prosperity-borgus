...
class Logger:
    ...
    def compress_listings(self, listings: List[Listing]) -> list[list[Any]]:
        compressed = []
...
class Trader:
    ...
    def run(self, state: TradingState) -> tuple[dict[Symbol, list[Order]], int, str]:
        ...
        # round 1
        result["KELP"] = Trade.kelp(self.state_resin)
        result["RAINFOREST_RESIN"] = Trade.resin(self.state_kelp)
